...
/*
 * This is the exact command used to control the robot in the 2 cone auto at kingston.
 * 
 * Here is how they were constructed:
...
public class ExampleAlignToTargetVision extends CommandBase {
  ...
  public ExampleAlignToTargetVision(boolean isTapeNotApril, double distFromTarget, double tolerance, double desiredVisionY, double desiredHeading, double vel, double accel, boolean finishedWhenAligned) {
